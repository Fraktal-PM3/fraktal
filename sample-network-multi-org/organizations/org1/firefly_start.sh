...
FIREFLY_PORT=${FIREFLY_PORT:-5000}
FIREFLY_UI_PORT=${FIREFLY_UI_PORT:-5001}
FABCONNECT_PORT=${FABCONNECT_PORT:-6000}
...
export PEER_HOST="org1-peer-gateway.org1.svc.cluster.local"
